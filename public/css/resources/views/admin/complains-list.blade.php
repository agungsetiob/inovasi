...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="input-group col-4">
            ...
            <input type="date" name="startdate" class="form-controls col-7" id="startdate" required>
        </div>
        <div class="input-group col-4">
            <label class="font-weight-bold col-5 mt-2">Sampai tanggal :</label>
            <input type="date" name="enddate" class="form-controls col-7" id="enddate" required>
        </div>
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$com->complain}} </td>
                            <td> {{$com->phone}} </td>
                            <td> {{$com->created_at->isoFormat('dddd, D MMMM Y')}} </td>
                            <td>
                                <button class="btn btn-danger btn-sm" title="hapus" data-toggle="modal" onclick="deleteMessage({{$com->id}})"><i class="fas fa-trash"></i></button>       
                            </tr>
                            @empty
...
<script>
    function deleteMessage(id){
        ...
        link.href = "{{ url('delete/pengaduan')}}/" + id
