        ...
        <div class="container">
            ...
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div class="portfolio-item mx-auto">
                    <a href="/inovasi"><img class="img-fluid menu-logo fa-bounce bounce-no-animation" src="assets/img/rocket.png" alt="..." /><p class="por masthead-subheading text-white font-weight-light mb-0">INOVASI</p></a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                <div class="portfolio-item mx-auto">
