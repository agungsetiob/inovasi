...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-light text-uppercase fixed-top border-bottom" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand" href="#page-top">
                <img width="60" src="assets/logo-serasi.png" alt="logo serasi" class="d-none d-md-inline-block">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="btn btn-lg btn-outline-danger" href="https://www.lapor.go.id/" target="_blank"><i class="fas fa-arrow-right fa-flip me-2" style="--fa-flip-x: 1; --fa-flip-y: 0;"></i>Lapor</a></li>
                    @if (Auth::guest())
