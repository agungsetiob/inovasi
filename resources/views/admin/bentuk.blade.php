                ...
                <table class="table table-borderless table-striped table-hover text-dark" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-danger btn-sm" title="hapus" data-toggle="modal" data-target="#deleteModal{{$ben->id}}"><i class="fas fa-trash"></i> Hapus</button>
                                ...
                                <form method="POST" action="{{url('enable/'. $ben->id)}}">
                                    @csrf
                                ...
                                <form method="POST" action="{{url('disable/'. $ben->id)}}">
                                    @csrf
                                    <div class="dropdown-menu animated--fade-in bg-gray-400" aria-labelledby="dropdownMenuButton">
